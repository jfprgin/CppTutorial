...
void handle_min(const vector<int> &numbers);
int find_min(const vector<int> &numbers);
void handle_max(const vector<int> &numbers);
...
void handle_min(const vector<int> &numbers)
{
    if (numbers.size() == 0) 
        ...
        cout << "The smallest number is: " << find_min(numbers) << endl;
}
...
void handle_max(const vector<int> &numbers)
{
    if (numbers.size() == 0)
        ...
        cout << "The largest number is: " <<find_max(numbers) << endl;
}
