...
class Account {
public:
    virtual void withdraw(double amount) {                          //you can only put it in the base class
...
public:
    virtual void withdraw(double amount) override {         //override so it overrides and not redefines
